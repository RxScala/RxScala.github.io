...
| `from(T[], Scheduler)`<br/>`from(Iterable<? extends T>, Scheduler)` | `from(Iterable[T], Scheduler)` |
| `from(T)`<br/>`from(T, T)`<br/>`from(T, T, T)`<br/>`from(T, T, T, T)`<br/>`from(T, T, T, T, T)`<br/>`from(T, T, T, T, T, T)`<br/>`from(T, T, T, T, T, T, T)`<br/>`from(T, T, T, T, T, T, T, T)`<br/>`from(T, T, T, T, T, T, T, T, T)`<br/>`from(T, T, T, T, T, T, T, T, T, T)` | use `items(T*)` |
...
| `merge(Array<Observable<? extends T>>, Scheduler)` | use `Observable.from(array, scheduler).flatten` |
...
| <span title="using(Func0&lt;Resource&gt;, Func1&lt;Resource, ? extends Observable&lt;? extends T&gt;&gt;)"><code>using(...)</code></span> | `using(() => Resource, Resource => Observable[T])` |
